...
*We can see the criticality of each of the minerals. However we can ask if there is a way to maximize supply. In this case we will just take a look to the Vanadium Market as it is the one that present the highest criticality.
...
solve CMM using lp maximizing SupplyRiskMin;
